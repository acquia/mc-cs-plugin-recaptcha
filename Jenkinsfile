...
pipeline {
  ...
  stages {
    ...
    stage('Automerge to development') {
      ...
      steps {
        script {
          def githubPR = httpRequest acceptType: 'APPLICATION_JSON', authentication: 'c6c13656-2d08-4391-b324-95085e23ce59', url: "https://api.github.com/repos/mautic-inc/plugin-salesforce/pulls/${CHANGE_ID}", validResponseCodes: '200'
